...
namespace Exiv2 {
    ...
    HeifImage::HeifImage(BasicIo::AutoPtr io, bool create)
    ...
    Image::AutoPtr newHeifInstance(BasicIo::AutoPtr io, bool create)
    {
        Image::AutoPtr image(new HeifImage(std::move(io), create));
        if (!image->good())
        {
            image.reset();
        }
